  ...
  return `
    <form class="friendly-form house-config-form half-metal-config" data-type="half-metal">
      ...
      <section class="form-section" data-priority="core"><div class="section-priority-header">
        ...
        <div class="col-md-6"><label class="form-label" for="halfMetalRoofType">Roof Type</label><select class="form-select" id="halfMetalRoofType" name="roofType"><option selected>Corrugated GI Sheet / Yero</option><option>Long Span Pre-Painted Roofing</option><option>Color Roof / Pre-painted Corrugated</option><option>Spandrel Ceiling Roof</option><option>Polycarbonate Sheet Roofing</option><option>Concrete Flat Deck Roof</option><option>Metal Stone-Coated / Tile Roof</option></select></div>
