...
export function getHalfMetalTemplate() {
  return `
    <form class="friendly-form house-config-form half-metal-config" data-type="half-metal">
      ...
      <section class="form-section"><div class="section-label"><span>1</span><div><h3>Shared costing inputs</h3><p>Applies to every house type.</p></div></div><div class="row g-4">
      ...
      <section class="form-section"><div class="section-label"><span>2</span><div><h3>Building dimensions and rooms</h3><p>Perimeter is auto-computed from L and W.</p></div></div><div class="row g-4">
      ...
      <section class="form-section"><div class="section-label"><span>3</span><div><h3>Walling and finishes</h3><p>CHB base height is fixed to the corrected engineer default.</p></div></div><div class="row g-4">
      ...
      <section class="form-section"><div class="section-label"><span>4</span><div><h3>Tile flooring</h3><p>Tile area uses building length and width.</p></div></div><div class="row g-4">
