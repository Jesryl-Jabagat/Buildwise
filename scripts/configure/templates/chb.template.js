  ...
  return `
    <form class="friendly-form house-config-form chb-config" data-type="chb">
      ...
      <section class="form-section">
        ...
        <div class="row g-3">
          <div class="col-md-6"><label class="form-label" for="chbLength">Length (m)</label><input class="form-control" id="chbLength" name="length" type="number" min="1" step="0.1" value="10" required></div>
          <div class="col-md-6"><label class="form-label" for="chbWidth">Width (m)</label><input class="form-control" id="chbWidth" name="width" type="number" min="1" step="0.1" value="8" required></div>
          ...
          <div class="col-md-6"><label class="form-label" for="chbCrs1F">Comfort Rooms (1st Floor)</label><select class="form-select" id="chbCrs1F" name="crs1F"><option>1</option><option selected>2</option><option>3</option></select></div>
