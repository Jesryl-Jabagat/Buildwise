    ...
    <form class="friendly-form house-config-form two-storey-config" data-type="two-storey">
      ...
      <section class="form-section" data-priority="core">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6"><label class="form-label" for="twoStoreyRoofType">Roof Type</label><select class="form-select" id="twoStoreyRoofType" name="roofType"><option selected>Corrugated GI Sheet / Yero</option><option>Long Span Pre-Painted Roofing</option><option>Color Roof / Pre-painted Corrugated</option><option>Spandrel Ceiling Roof</option><option>Polycarbonate Sheet Roofing</option><option>Concrete Flat Deck Roof</option><option>Metal Stone-Coated / Tile Roof</option></select></div>
